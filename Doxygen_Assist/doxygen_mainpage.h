...
\li <a href="https://github.com/HaiwangYu/seaquest-offline/tree/master/ktracker"> seaquest-offline/ktracker </a>: current root interface and reconstruction package
\li <a href="https://github.com/HaiwangYu/seaquest-offline/tree/master/fun4all"> seaquest-offline/fun4all </a>: prototype 'Fun4All' implementation of the SeaQuest offline software
...
\li How a class is inherited? Check out the <b>Inheritance diagram</b> in the class pages. They are auto folded by default. Example: click <i>"Inheritance diagram for SQHit_v1"</i> in page \ref SQHit_v1. 
\li Find out <b>inter-dependencies between files</b>. Example is on \ref SQHit_v1.cc page, you can try clicking to unfold <i>"Include dependency graph"</i> and <i>"files directly or indirectly include this file"</i>.
\li Highlighted <b>source code</b> with crossreferencing. Example click <i>"Go to the source code"</i> in \ref SQHit_v1.cc .
